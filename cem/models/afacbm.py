...
class AFAModel(pl.LightningModule, InterventionPolicy):
    def __init__(self, cbm, config):
        ...
        self.env = AFAEnv(self.cbm, self.ac_model, config)
        self.agent = PPOLightningAgent(
            self.env,
            act_fun = config["activation_function"],
    ...
    def _run_step(self, batch, train = False):
